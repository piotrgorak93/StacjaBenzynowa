...
public class Pojazd extends Thread {
    ...
    public void jedz() {
        ...
        double dystans = gps.minDystans(zrodlo);
        ...
        double dystans2 = gps2.minDystans(cel);
        System.out.println("W trasie spale "+ileSpale(dystans2));
        setCzyJechacField(czyDojade(dystans2));
